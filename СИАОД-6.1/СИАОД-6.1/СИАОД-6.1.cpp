...
int main() {
    ...
    hash.insert(6666666, "Лясковский Тимофей Максимович", "Орел, ...");
    hash.insert(7777777, "Коротков Алексей Александрович", "Казань, ...");
    hash.insert(7777777, "Жагло Игорь Дмитриевич", "Усть-Лабинск, ...");*/
    hash.print();
    while (true) {
